...
SPESE = {
    ...
    "Revolut": ["Trasporti", "Sport", "Bollette", "Pulizia Casa", "Psicologo", "Altro/Cane", "Beneficienza", "Netflix", "Spotify", "Disney+", "Emergenze/Compleanni", "Viaggi", "Da spendere", "Spese quotidiane"],
...
def create_charts(stipendio_scelto, risparmiabili, df_altre_entrate):
    ...
    df_fisse.loc[(df_fisse["Categoria"] == "Sport") | (df_fisse["Categoria"] == "Psicologo") | (df_fisse["Categoria"] == "Altro/Cane"), "Categoria"] = "Salute"
    ...
    with col1:
        ...
        with col_left:
            for voce, importo in SPESE["Fisse"].items():
                ...
                elif voce in ["Sport", "Psicologo", "Altro/Cane"]:
    ...
    with col3:
        ...
        for carta in ["ING", "Revolut", "BNL"]:
            ...
            if carta == "Revolut":
                ...
                testo = "trasferire"
                somma_spese_programmate_immediate = SPESE["Fisse"]["Psicologo"] + SPESE["Fisse"]["Sport"] + SPESE["Fisse"]["Altro/Cane"] + SPESE["Fisse"]["Trasporti"] + SPESE["Fisse"]["Bollette"] + SPESE["Fisse"]["Beneficienza"] + SPESE["Fisse"]["Pulizia Casa"] + SPESE["Fisse"]["Disney+"] + SPESE["Fisse"]["Netflix"] + SPESE["Fisse"]["Spotify"]
